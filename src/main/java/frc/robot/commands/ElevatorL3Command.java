...
/*public class ElevatorL3Command extends PIDCommand { 
    ...
    public ElevatorL3Command(ElevatorSubsystem subsystem, boolean h){
        super ( new PIDController(Constants.ElevatorConstants.kp,Constants.ElevatorConstants.ki, Constants.ElevatorConstants.kd ), Constants.ElevatorConstants.L4,subsystem.getmotorconsumer());
        hold = h;
        arm=subsystem;
        addRequirements(subsystem);
    ...
    public void execute (){
        super.execute();
        arm.setSetPoint(Constants.AlgaeArmConstants.L3_POSITION);
    }
